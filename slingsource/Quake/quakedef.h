...
Copyright (C) 2017 Sling Developers
...
#define SLING_VERSION	2.11	//sling, removed unneeded codecs 1.00>1.01
...
#define	GAMENAME	"slingbase"		// directory to look in by default
